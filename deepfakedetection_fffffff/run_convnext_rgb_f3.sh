...
VAL_ROOT=/data/workspace/wangjunjun/DeepFakeDetection/Dataset/Ali2024/phase1/crop_valset/crop
VAL_CSV=/data/workspace/wangjunjun/DeepFakeDetection/Dataset/Ali2024/phase1/valset_label.txt


# ===== 训练超参（ConvNeXt 微调常用） =====
IMG=384
BS=32                   # 每卡 batch size（显存充足可调大）
EPOCHS=20
WARMUP=2
LR_BB=5e-5
LR_HEAD=1e-3
